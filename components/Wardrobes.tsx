...
export function Wardrobes() {
  return (
    <section id="wardrobes" className="compact">
      ...
      <CatalogBlock
        id="wardrobe-styles"
        breadcrumb={{ parent: "Wardrobes", current: "Styles" }}
        title="Browse wardrobe styles"
        intro="Every style is made to measure in our Leicester workshop — pick a starting point, then we tailor layout, finishes and internals to your room."
      >
        <Catalog
          id="wardrobes"
          ariaLabel="Filter wardrobe styles"
          sidebarTitle="Categories"
          filters={wardrobeFilters}
          countSuffix="styles"
          initialCount={12}
          sidebarNote="Prices on enquiry — every job is bespoke"
          variant="products"
